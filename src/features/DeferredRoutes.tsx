...
export function Winrates({ classes, loading, switching, error, updatedAt, matchupsData, matchupsLoading, matchupsError, winrateSource, onSourceChange, onNavigate, authUser, subscriptionStatus, subscriptionLoading, onRefreshSubscription }: {
              ...
              <>
                {activeTab === 'home' && (
                  ...
                  />
                    ...
                    matchupsData={classMatchupsData}
                    matchupsLoading={loadingClassMatchups}
                    matchupsError={errorClassMatchups}
